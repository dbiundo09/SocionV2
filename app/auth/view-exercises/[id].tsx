        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                {exercises.map((exercise) => (
                    <TouchableOpacity
                        key={exercise.video_url || exercise.audio_url}
                        style={styles.exerciseCard}
                        onPress={() => router.push(`/auth/exercise-details/${exercise.class_id}`)}
                    >
                        <View style={styles.exerciseHeader}>
                            <Text style={styles.exerciseName}>{exercise.exercise_name}</Text>
                            <Ionicons
                                name={exercise.video_url ? 'videocam' : 'musical-notes'}
                                size={24}
                                color="#8B5CF6"
                            />
                        </View>
                        ...
                        <View style={styles.exerciseDetails}>
                            ...
                            <View style={styles.detailItem}>
                                ...
                                <Text style={styles.detailText}>
                                    {formatDate(exercise.start_time)} - {formatDate(exercise.end_time)}
                                </Text>
                            </View>
                        </View>
                    </TouchableOpacity>
